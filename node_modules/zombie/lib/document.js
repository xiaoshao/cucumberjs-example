...
function setupWindow(window, args) {
  ...
  window._submit = function (formArgs) {
    var url = DOM.resourceLoader.resolve(document, formArgs.url);
...
function getHTMLFromResponseBody(buffer, contentType) {
  ...
  var mimeType = _contentType$split[0];

  var typeOptions = _contentType$split.slice(1);

  // Pick charset from content type
  if (mimeType) {
    for (var _iterator = typeOptions, _isArray = _core.Array.isArray(_iterator), _i = 0, _iterator = _isArray ? _iterator : _core.getIterator(_iterator);;) {
      var _ref;
...
function parseResponse(_ref2) {
  ...
  var window, done;
  return _regeneratorRuntime.async(function parseResponse$(context$1$0) {
    var _this = this;

    while (1) switch (context$1$0.prev = context$1$0.next) {
      case 0:
        window = document.defaultView;
        done = window._eventQueue.waitForCompletion();
        context$1$0.prev = 2;
        context$1$0.next = 5;
        return (function callee$1$0() {
          var buffer, contentType, html, refreshURL;
          return _regeneratorRuntime.async(function callee$1$0$(context$2$0) {
            while (1) switch (context$2$0.prev = context$2$0.next) {
              case 0:
                ...
                context$2$0.next = 5;
                return response._consume();

              case 5:
                buffer = context$2$0.sent;
                contentType = response.headers.get('Content-Type') || '';
                html = getHTMLFromResponseBody(buffer, contentType);
              ...
              case 15:
                ...
                refreshURL = getMetaRefreshURL(document);
      ...
      case 7:
        ...
        browser.emit('error', context$1$0.t0);
...
module.exports = function loadDocument(args) {
  ...
  window._eventQueue.http(request, function callee$1$0(error, response) {
    return _regeneratorRuntime.async(function callee$1$0$(context$2$0) {
      while (1) switch (context$2$0.prev = context$2$0.next) {
        case 0:
          if (error) {
