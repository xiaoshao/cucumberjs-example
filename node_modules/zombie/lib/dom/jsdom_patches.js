...
_core.Object.defineProperty(DOM.CSSStyleDeclaration.prototype, 'opacity', {
  get: function get() {
...
DOM.Document.prototype.raise = function (type, message, data) {
  ...
  if (error.stack) {
    for (var _iterator = error.stack.split('\n'), _isArray = _core.Array.isArray(_iterator), _i = 0, _iterator = _isArray ? _iterator : _core.getIterator(_iterator);;) {
      var _ref;
...
DOM.resourceLoader.load = function (element, href, callback) {
  ...
  if (loadResource) {
    (function () {
      ...
      var enqueued = _this2.enqueue(element, callback && callback.bind(element), url);
