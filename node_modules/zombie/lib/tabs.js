  ...
  Object.defineProperties(tabs, {
    ...
    dump: {
      value: function value() {
        ...
        if (tabs.length === 0) output.write("No open tabs.\n");else for (var _iterator = tabs, _isArray = Array.isArray(_iterator), _i = 0, _iterator = _isArray ? _iterator : _core.$for.getIterator(_iterator);;) {
            var _ref;
