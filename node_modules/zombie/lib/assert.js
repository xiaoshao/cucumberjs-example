...
module.exports = (function () {
  ...
  Assert.prototype.attribute = function attribute(selector, name) {
    ...
    for (var _iterator = elements, _isArray = _core.Array.isArray(_iterator), _i = 0, _iterator = _isArray ? _iterator : _core.getIterator(_iterator);;) {
      var _ref;
  ...
  Assert.prototype.elements = (function (_elements) {
  ...
  Assert.prototype.hasClass = function hasClass(selector, expected, message) {
    var elements = this.browser.queryAll(selector);
    assert(elements.length, 'Expected selector "' + selector + '" to return one or more elements');
    for (var _iterator2 = elements, _isArray2 = _core.Array.isArray(_iterator2), _i2 = 0, _iterator2 = _isArray2 ? _iterator2 : _core.getIterator(_iterator2);;) {
      var _ref2;
  ...
  Assert.prototype.hasNoClass = function hasNoClass(selector, expected, message) {
    var elements = this.browser.queryAll(selector);
    assert(elements.length, 'Expected selector "' + selector + '" to return one or more elements');
    for (var _iterator3 = elements, _isArray3 = _core.Array.isArray(_iterator3), _i3 = 0, _iterator3 = _isArray3 ? _iterator3 : _core.getIterator(_iterator3);;) {
      var _ref3;
  ...
  Assert.prototype.className = function className(selector, expected, message) {
    ...
    for (var _iterator4 = elements, _isArray4 = _core.Array.isArray(_iterator4), _i4 = 0, _iterator4 = _isArray4 ? _iterator4 : _core.getIterator(_iterator4);;) {
      var _ref4;
  ...
  Assert.prototype.style = (function (_style) {
    ...
    var elements = this.browser.queryAll(selector);
    assert(elements.length, 'Expected selector "' + selector + '" to return one or more elements');
    for (var _iterator5 = elements, _isArray5 = _core.Array.isArray(_iterator5), _i5 = 0, _iterator5 = _isArray5 ? _iterator5 : _core.getIterator(_iterator5);;) {
      var _ref5;
  ...
  Assert.prototype.input = function input(selector) {
    ...
    var elements = this.browser.queryAll(selector);
    assert(elements.length, 'Expected selector "' + selector + '" to return one or more elements');
    for (var _iterator6 = elements, _isArray6 = _core.Array.isArray(_iterator6), _i6 = 0, _iterator6 = _isArray6 ? _iterator6 : _core.getIterator(_iterator6);;) {
      var _ref6;
