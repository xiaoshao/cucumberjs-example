...
var EventQueue = (function () {
  ...
  EventQueue.prototype.destroy = function destroy() {
    ...
    for (var _iterator = this.timers, _isArray = _core.Array.isArray(_iterator), _i = 0, _iterator = _isArray ? _iterator : _core.getIterator(_iterator);;) {
      var _ref;
    ...
    for (var _iterator2 = this.eventSources, _isArray2 = _core.Array.isArray(_iterator2), _i2 = 0, _iterator2 = _isArray2 ? _iterator2 : _core.getIterator(_iterator2);;) {
      var _ref2;
  ...
  EventQueue.prototype.waitForCompletion = function waitForCompletion() {
    var _this3 = this;
  ...
  EventQueue.prototype.dequeue = function dequeue() {
    ...
    if (fn) {
      return fn;
    }for (var _iterator3 = _core.Array.from(this.window.frames), _isArray3 = _core.Array.isArray(_iterator3), _i3 = 0, _iterator3 = _isArray3 ? _iterator3 : _core.getIterator(_iterator3);;) {
      var _ref3;
  ...
  EventQueue.prototype.http = function http(request, callback) {
    var _this4 = this;
